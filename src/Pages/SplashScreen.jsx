  ...
  return (
    <Paper  >
        {screen==0 && <Box sx={{minHeight: "100vh", width: "100vw",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center" }}>
            <Box component="img" src="https://i.postimg.cc/D0qkLpSj/medchant.png" sx={{width:"200px"}} className="grow"/>
          <Typography variant="h6" sx={{marginTop:"1vh"}} color="primary.main">Welcome to MedChant</Typography>
        </Box>}
